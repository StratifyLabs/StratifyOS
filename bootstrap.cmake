...
if(CLONE)
    ...
    sos_sdk_clone(https://github.com/StratifyLabs/StratifyOS-libusb.git ..)
		sos_sdk_clone(ssh://git@github.com/tyler-gilbert/CloudAPI.git ..)
		sos_sdk_clone(ssh://git@github.com/tyler-gilbert/ServiceAPI.git ..)
...
if(BUILD)
    ...
    sos_sdk_build_lib(../StratifyAPI ON link)
		sos_sdk_build_lib(../CloudAPI ON link)
		sos_sdk_build_lib(../ServiceAPI ON link)
