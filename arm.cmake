...
if(BUILD_CORTEXM OR BUILD_ALL)
  ...
  target_compile_options(${CORTEXM_RELEASE_TARGET} PUBLIC -Os $<$<COMPILE_LANGUAGE:CXX>:-fpermissive>)
...
if(BUILD_MCU OR BUILD_ALL)
  ...
  target_compile_options(${MCU_RELEASE_TARGET} PUBLIC -Os )
	add_lwip_path(${MCU_RELEASE_TARGET} PRIVATE)
...
if(BUILD_CRT OR BUILD_ALL)
  ...
  target_compile_options(${CRT_RELEASE_TARGET} PUBLIC -mlong-calls $<$<COMPILE_LANGUAGE:CXX>:-fpermissive> PRIVATE -Os)
