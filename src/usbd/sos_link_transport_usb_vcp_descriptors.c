...
SOS_LINK_TRANSPORT_USB_CONST(vcp, usbd_cdc_event_handler)

SOS_LINK_TRANSPORT_USB_DEVICE_DESCRIPTOR(
  vcp,
  USBD_DEVICE_CLASS_COMMUNICATIONS,
  0,
  0,
  SOS_LINK_TRANSPORT_USB_BCD_VERSION | 1)

const sos_link_transport_usb_vcp_configuration_descriptor_t
  sos_link_transport_usb_vcp_configuration_descriptor MCU_WEAK = {

    .cfg =
      {.bLength = sizeof(usbd_configuration_descriptor_t),
       .bDescriptorType = USBD_DESCRIPTOR_TYPE_CONFIGURATION,
       .wTotalLength = sizeof(sos_link_transport_usb_vcp_configuration_descriptor_t)
 ...
 *
 */
const struct sos_link_transport_usb_vcp_string_descriptor_t
  sos_link_transport_usb_vcp_string_descriptor MCU_WEAK = {
    .bLength = 4,
    ...
    .vcp = USBD_ASSIGN_STRING(
      SOS_LINK_TRANSPORT_USB_DESC_VCP_SIZE,
      SOS_LINK_TRANSPORT_USB_DESC_VCP),
};
