...
void _mcu_core_sct0_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_mtr0_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_wkttmr_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_uart0_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_uart1_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_uart2_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_i2c0_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_i2c1_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_i2c2_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_i2c3_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_spi0_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_spi1_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_adcseqa_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_adcseqb_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_adcthres_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_adcover_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_cmp_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_bod_isr() MCU_ALIAS(_mcu_core_default_isr);
void _mcu_core_dma_isr() MCU_ALIAS(_mcu_core_default_isr);
