...
set(LINKER_FLAGS "-L${TOOLCHAIN_LIB_DIR}/${SOS_BSP_ARCH}/${BUILD_FLOAT}/. -Wl,-Map,${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${SOS_BSP_NAME}_${SOS_BSP_CONFIG}.map,--gc${BUILD_HARDWARD_ID} -Ttext=${SOS_BSP_START_ADDRESS} -Tldscripts/${SOS_BSP_DEVICE}-rom.ld -nostdlib -u ${BUILD_UNDEFINE_SYMBOL}")
...
target_compile_definitions(${SOS_BSP_NAME}_${SOS_BSP_CONFIG}.elf __${BUILD_TYPE} HARDWARE_ID=${SOS_BSP_HARDWARD_ID} __${SOS_BSP_DEVICE_FAMILY} __${BUILD_ARCH} __${SOS_BSP_DEVICE} ${SOS_BSP_DEFINITIONS})
