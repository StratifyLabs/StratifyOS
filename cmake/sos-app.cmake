...
if(SOS_ARCH STREQUAL "link")
	...
	add_executable(${BUILD_TARGET} ${SOS_SOURCELIST})
	add_custom_target(bin_${SOS_NAME}_${SOS_ARCH} DEPENDS ${BUILD_TARGET} COMMAND ${CMAKE_OBJCOPY} -j .text -j .data -O binary ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${BUILD_TARGET} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${SOS_NAME})
	add_custom_target(asm_${SOS_NAME}_${SOS_ARCH} DEPENDS bin_${SOS_NAME}_${SOS_ARCH} COMMAND ${CMAKE_OBJDUMP} -S -j .text -j .priv_code -j .data -j .bss -j .sysmem -d ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${BUILD_TARGET} > ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${SOS_NAME}_${SOS_CONFIG}.lst)
	add_custom_target(size_${SOS_ARCH} DEPENDS asm_${SOS_NAME}_${SOS_ARCH} COMMAND ${CMAKE_SIZE} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${BUILD_TARGET})
	add_custom_target(${SOS_ARCH} ALL DEPENDS size_${SOS_ARCH})
