...
if( SOS_SDK_PATH_TO_MAKE )
	set(SOS_SDK_MAKE_EXEC ${SOS_SDK_PATH_TO_CMAKE}/make${SOS_SDK_EXEC_SUFFIX})
else()
...
function(sos_sdk_build_qt_lib PATH PROJECT CONFIG)
	...
	execute_process(COMMAND ${SOS_SDK_QMAKE_EXEC} ${PATH}/${PROJECT}/${PROJECT}.pro	${SOS_SDK_QMAKE_ARGS} WORKING_DIRECTORY ${PATH}/build_${CONFIG})
	if(SOS_SDK_CLEAN_ALL)
		message(STATUS "Clean: " ${PROJECT})
		execute_process(COMMAND ${SOS_SDK_MAKE_EXEC} clean WORKING_DIRECTORY ${PATH}/build_${CONFIG})
	endif()
