...
set(CMAKE_C_FLAGS "${TOOLCHAIN_C_FLAGS} -D__win32 -mno-ms-bitfields" CACHE INTERNAL "MINGW C FLAGS")
set(CMAKE_CXX_FLAGS "${TOOLCHAIN_C_FLAGS} ${TOOLCHAIN_CXX_FLAGS}" CACHE INTERNAL "MINGW CXX FLAGS")
