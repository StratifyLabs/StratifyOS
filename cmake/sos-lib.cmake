...
elseif( ${SOS_LIB_ARCH} STREQUAL armv7e-m )
	...
	set(BUILD_LIB_ARCH -march=${SOS_LIB_ARCH})
elseif( ${SOS_LIB_ARCH} STREQUAL armv7e-m_fpuv5 )
	set(BUILD_FLOAT "${SOS_BUILD_FLOAT_DIR_ARMV7EM_FPUV5}" CACHE INTERNAL "build float dir")
	set(BUILD_ARM_ARCH "armv7em_fpuv5" CACHE INTERNAL "build device")
	set(INSTALL_ARM_ARCH ${SOS_BUILD_INSTALL_DIR_ARMV7EM_FPUV5} CACHE INTERNAL "build device")
	set(BUILD_FLOAT_OPTIONS ${SOS_BUILD_FLOAT_OPTIONS_ARMV7EM_FPUV5} CACHE INTERNAL "build float options")
	set(BUILD_LIB_ARCH -march=armv7e-m)
