...
target_compile_definitions(${BUILD_LIBRARY_TARGET} PUBLIC ${LIB_OPTION_DEFINE} __${SOS_LIB_TYPE} __${SOS_BUILD_ARCH} ${SOS_LIB_DEFINITIONS} SOS_GIT_HASH="${SOS_GIT_HASH}")
