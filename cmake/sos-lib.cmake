...
target_compile_definitions(${BUILD_LIBRARY_TARGET} PUBLIC __${SOS_LIB_OPTION} __${SOS_LIB_TYPE} __${SOS_BUILD_ARCH} ${SOS_LIB_DEFINITIONS} SOS_GIT_HASH="${SOS_GIT_HASH}")
