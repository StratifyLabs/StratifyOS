...
#define mg_set_data 0
#define mg_data 0
#define mg_set_size 0
#define mg_calc_size 0
#define mg_size 0
#define mg_byte_width 0
#define mg_word_width 0
#define mg_calc_byte_width 0
#define mg_calc_word_width 0
#define mg_x_max 0
#define mg_y_max 0
#define mg_bound 0
#define mg_bound_x 0
...
#define mg_flip_y 0
#define mg_flip_xy 0
#define mg_shift_right 0
#define mg_shift_left 0
#define mg_shift_up 0
#define mg_shift_down 0
#define mg_op_set 0
#define mg_op_clr 0
#define mg_op_inv 0
#define mg_set_bitmap 0
#define mg_clr_bitmap 0
#define mg_inv_bitmap 0
#define mg_set_bitmap_column 0
#define mg_setbitmap_row 0
#define mg_tst_hline 0
#define mg_tst_hedge 0
#define mg_set_vline 0
#define mg_set_hline 0
#define mg_clr_vline 0
#define mg_clr_hline 0
#define mg_set_line 0
#define mg_clr_line 0
#define mg_set_rect 0
#define mg_tst_pixel 0
#define mg_tst_bounded_pixel 0
#define mg_set_pixel 0
#define mg_set_bounded_pixel 0
#define mg_inv_pixel 0
#define mg_inv_bounded_pixel 0
#define mg_clr_pixel 0
#define mg_clr_bounded_pixel 0
#define mg_clr 0
#define mg_set 0
#define mg_inv 0
#define mg_inv_rows 0
#define mg_fill 0
#define mg_fill_rows 0
#define mg_fill_area 0
#define mg_pour 0
#define mg_show 0
#define mg_draw 0
#define mg_draw_list 0
#define mg_point_set 0
#define mg_point_map 0
#define mg_point_map_pixel_size 0
#define mg_point_add 0
#define mg_point_subtract 0
#define mg_point_rotate 0
#define mg_point_scale 0
#define mg_point_shift 0
#define mg_point_shift_x 0
#define mg_point_shift_y 0
#define mg_set_bitmap_area 0
#define mg_clr_bitmap_area 0
#define mg_inv_bitmap_area 0
#define mg_set_area 0
#define mg_clr_area 0
#define mg_inv_area 0
#define mg_draw_icon 0
#define mg_animate 0
#define mg_animate_init 0
#endif
