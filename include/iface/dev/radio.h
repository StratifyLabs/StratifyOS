...
#ifndef IFACE_DEV_RADIO_H_
#define IFACE_DEV_RADIO_H_
 ...
 * Example:
 * \code
 * ioctl(fildes, I_RADIO_GETATTR);
 * \endcode
 * \hideinitializer
 */
#define I_RADIO_GETATTR _IOCTLR(RADIO_IOC_CHAR, 0, radio_attr_t)
