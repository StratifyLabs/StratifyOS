 ...
 * ioctl(fd, I_DISPLAY_GETATTR, &attr);
...
/*! \file  */
#ifndef IFACE_DEV_DISPLAY_H_
#define IFACE_DEV_DISPLAY_H_
 ...
 * \code
 * display_attr_t attr;
 * ioctl(fildes, I_DISPLAY_GETATTR, &attr);
 * \endcode
 * \hideinitializer
 */
#define I_DISPLAY_GETATTR _IOCTLR(DISPLAY_IOC_CHAR, 0, display_attr_t)
