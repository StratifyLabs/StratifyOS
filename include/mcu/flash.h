 ...
 *
 */
int mcu_flash_open(const devfs_handle_t * cfg) MCU_ROOT_CODE;
/*! \details
 * \sa periph_read()
 *
 */
int mcu_flash_read(const devfs_handle_t * cfg, devfs_async_t * rop) MCU_ROOT_CODE;
/*! \details
 * \sa periph_write()
 */
int mcu_flash_write(const devfs_handle_t * cfg, devfs_async_t * wop) MCU_ROOT_CODE;
/*! \details
 * \sa periph_ioctl()
 *
 */
int mcu_flash_ioctl(const devfs_handle_t * cfg, int request, void * ctl) MCU_ROOT_CODE;
/*! \details
 * \sa periph_close()
 */
int mcu_flash_close(const devfs_handle_t * cfg) MCU_ROOT_CODE;
