...
u64 task_priv_gettime(int tid) MCU_PRIV_CODE;
 ...
 */
void task_priv_del(int id /*! The task to delete */) MCU_PRIV_CODE;

void task_priv_switch_context(void*) MCU_PRIV_CODE;


void task_priv_resetstack(int id) MCU_PRIV_CODE;
...
void task_priv_interrupt(void * args) MCU_PRIV_CODE;
