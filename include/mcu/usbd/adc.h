...
#define USBD_ADC_INTERFACE_SUBCLASS_AUDIOCONTROL 0x01
#define USBD_ADC_INTERFACE_SUBCLASS_AUDIOSTREAMING 0x02
#define USBD_ADC_INTERFACE_SUBCLASS_MIDISTREAMING 0x03
