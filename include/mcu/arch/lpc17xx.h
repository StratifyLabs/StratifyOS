...
#define MCU_SPI_PORTS 3 //Two SSP and one SPI -- SSP can be access on ports 0 and 1, SPI is on port 2
...
#define MCU_UART_REGS { (LPC_UART_TypeDef *)LPC_UART0, (LPC_UART_TypeDef *)LPC_UART1, LPC_UART2, LPC_UART3 }
