...
/******  LPC13xx Specific Interrupt Numbers *******************************************************/
  ...
  WAKEUP1_IRQn                  = 1,        /*!< There are 40 pins in total for LPC13xx           */
  WAKEUP2_IRQn                  = 2,
  WAKEUP3_IRQn                  = 3,
  WAKEUP4_IRQn                  = 4,
  WAKEUP5_IRQn                  = 5,
...
#define LPC_TMR16B0           ((LPC_TMR_Type    *) LPC_CT16B0_BASE)
#define LPC_TMR16B1           ((LPC_TMR_Type    *) LPC_CT16B1_BASE)
#define LPC_TMR32B0           ((LPC_TMR_Type    *) LPC_CT32B0_BASE)
#define LPC_TMR32B1           ((LPC_TMR_Type    *) LPC_CT32B1_BASE)
