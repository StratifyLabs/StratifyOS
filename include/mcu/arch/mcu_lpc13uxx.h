...
typedef LPC_I2C_Type LPC_I2C_Type;
typedef LPC_USART_Type LPC_UART_Type;
typedef LPC_SSP0_Type LPC_SSP_Type;
typedef LPC_ADC_Type LPC_ADC_Type;
typedef LPC_USB_Type LPC_USB_Type;
typedef LPC_CT16B0_Type LPC_CT16B0_Type;
typedef LPC_CT16B1_Type LPC_CT16B1_Type;
typedef LPC_CT32B0_Type LPC_CT32B0_Type;
typedef LPC_CT32B1_Type LPC_CT32B1_Type;
