...
#include "mcu/arch/LPC13xx_cm3.h"
...
#define MCU_SSP_PORTS MCU_SPI_PORTS
#define MCU_SSP_REGS { LPC_SSP0 }
#define MCU_GPIO_PORTS 4
#define MCU_GPIO_REGS { LPC_GPIO0, LPC_GPIO1, LPC_GPIO2, LPC_GPIO3 }
#define MCU_PIO_PORTS MCU_GPIO_PORTS
#define MCU_PIO_REGS { LPC_GPIO0, LPC_GPIO1, LPC_GPIO2, LPC_GPIO3 }
#define MCU_I2C_PORTS 1
#define MCU_I2C_REGS { LPC_I2C }
#define MCU_UART_PORTS 1
#define MCU_UART_REGS { LPC_UART }
#define MCU_TMR_PORTS 4
#define MCU_TMR_REGS { LPC_TMR16B0, LPC_TMR16B1, LPC_TMR32B0, LPC_TMR32B1 }
#define MCU_EINT_PORTS 40
