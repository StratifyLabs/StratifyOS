...
#include "mcu/arch/lpc8xx/chip.h"
...
#define DEV_LAST_IRQ PIN_INT7_IRQn
...
#include "mcu_lpc13xx_flags.h"

#define MCU_CORE_PORTS 1
#define MCU_SPI_PORTS 0
#define MCU_SSP_PORTS 2
#define MCU_SSP_REGS { LPC_SPI0, LPC_SPI1 }
#define MCU_PIO_PORTS 1
#define MCU_PIO_REGS { LPC_GPIO_PORT }
#define MCU_I2C_PORTS 4
#define MCU_I2C_REGS { LPC_I2C0, LPC_I2C1, LPC_I2C2, LPC_I2C3 }
#define MCU_UART_PORTS 1
#define MCU_UART_REGS { LPC_USART }
#define MCU_TMR_PORTS 4
#define MCU_TMR_REGS { (LPC_TMR_Type*)LPC_CT16B0, (LPC_TMR_Type*)LPC_CT16B1, (LPC_TMR_Type*)LPC_CT32B0, (LPC_TMR_Type*)LPC_CT32B1 }
...
typedef LPC_I2C_T LPC_I2C_Type;
typedef LPC_USART_T LPC_UART_Type;
typedef LPC_SPI_T LPC_SSP_Type;
typedef LPC_ADC_T LPC_ADC_Type;
//typedef LPC_USB_Type LPC_USB_Type;
typedef LPC_SCT_T LPC_CT16B0_Type;
typedef LPC_SCT_T LPC_CT16B1_Type;
typedef LPC_SCT_T LPC_CT32B0_Type;
typedef LPC_SCT_T LPC_CT32B1_Type;
/*
typedef LPC_IOCON_Type LPC_IOCON_Type;
typedef LPC_GPIO_Type LPC_GPIO_Type;
typedef LPC_CT32B1_Type LPC_TMR_Type;
typedef LPC_USB_Type LPC_USB_Type;
*/
