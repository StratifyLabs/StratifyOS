...
typedef LPC_I2C_T LPC_I2C_TypeDef;
typedef LPC_USART_T LPC_UART_TypeDef;
typedef LPC_SPI_T LPC_SSP_TypeDef;
typedef LPC_ADC_T LPC_ADC_TypeDef;
//typedef LPC_USB_Type LPC_USB_TypeDef;
typedef LPC_SCT_T LPC_CT16B0_TypeDef;
typedef LPC_SCT_T LPC_CT16B1_TypeDef;
typedef LPC_SCT_T LPC_CT32B0_TypeDef;
typedef LPC_SCT_T LPC_CT32B1_TypeDef;
/*
