...
#define ASSETFS_ENTRY(file_name, object_name, mode_value) \
{ .name = file_name, .start = ASSETFS_START(object_name), .end = ASSETFS_END(object_name), .mode = mode_value }
...
#define ASSETFS_MOUNT(mount_loc_name, cfgp, access_mode) { \
