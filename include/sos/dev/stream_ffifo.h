...
#define I_STREAM_FFIFO_GETINFO                                                           \
  _IOCTLR(STREAM_FFIFO_IOC_IDENT_CHAR, I_MCU_GETINFO, stream_ffifo_info_t)
#define I_STREAM_FFIFO_SETATTR                                                           \
  _IOCTLW(STREAM_FFIFO_IOC_IDENT_CHAR, I_MCU_SETATTR, stream_ffifo_attr_t)
#define I_STREAM_FFIFO_SETACTION                                                         \
  _IOCTLW(STREAM_FFIFO_IOC_IDENT_CHAR, I_MCU_SETACTION, mcu_action_t)
