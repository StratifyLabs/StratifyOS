...
#ifndef SOS_DEV_ENET_H_
#define SOS_DEV_ENET_H_
 ...
 */
#define I_ENET_GETINFO _IOCTLR(ENET_IOC_IDENT_CHAR, I_MCU_GETINFO, enet_attr_t)

/*! \brief IOCTL request to set the attributes (set pin assignment)
 */
#define I_ENET_SETATTR _IOCTLW(ENET_IOC_IDENT_CHAR, I_MCU_SETATTR, enet_attr_t)
 ...
 * action.o_events = ENET_ACTION_EVENT_RISING; //Trigger on rising edge
