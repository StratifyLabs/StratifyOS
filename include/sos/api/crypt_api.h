...
typedef struct {
  ...
  int (*set_key)(void *context, const unsigned char *key, u32 keybits, u32 bits_per_word);

  int (
    *encrypt_ecb)(void *context, const unsigned char input[16], unsigned char output[16]);

  int (
    *decrypt_ecb)(void *context, const unsigned char input[16], unsigned char output[16]);
